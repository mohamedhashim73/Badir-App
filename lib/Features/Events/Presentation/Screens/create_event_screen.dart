                  ...
                  [
                    ...
                    DefaultButton(
                      ...
                      onTap: ()
                      {
                        ...
                        {
                          cubit.createEvent(layoutCubit: layoutCubit, forPublic: cubit.eventForPublic, name: _nameController.text, description: _descriptionController.text, startDate: _descriptionController.text, endDate: _endDateController.text, time: _timeController.text, location: _locationController.text, link: _linkController.text, clubID: clubsCubit.dataAboutClubYouLead!.id.toString(), clubName: clubsCubit.dataAboutClubYouLead!.name);
                        }
                        else
                        {
